...
const MoveToBankHistory = () => {
    ...
    return (
        ...
        <UserNav userRole={kycData?.user_type_label} />
            ...
            <div className='container fundRequestHistory mt-4 mb-3 main-bg'>
                <h2 style={{ color: "#e21d24" }}>Move To Bank <span style={{ color: "#2e26c6" }}> History</span></h2>
                <div className='row'>
                    <div className='col-12 mt-3 mb-3 '>
                        ...
                        <div className="container">
                            <table className="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <tr>
                                        <th scope="row">25/5/2023 12:32 Am</th>
...
export default MoveToBankHistory;
