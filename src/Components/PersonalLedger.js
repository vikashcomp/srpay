...
const PersonalLedger = () => {
    ...
    const [tableData, setTableData] = useState([
        { id: 1, date: '12-10-2022', txnId: 'TXN123', description: "ttrrryy", paymentMode: 'Credit Card', debit: 2000, credit: 400, closingbalance: "25,0000", view: "lorem" },
    ...
    return (
        <>
            <div className='container fundRequestHistory mt-3 mb-5'>
                <h2 style={{ color: "#e21d24" }}> Ledger <span style={{ color: "#2e26c6" }}>Details</span></h2>
                <div className='row main-bg'>
                    <div className='col-12 mt-3'>
                        ...
                        <div className='d-flex  mb-3 right-button'>
                            <div className="ms-5 mt-3 search-button">
                                <button className="btn btn-primary" onClick={handleExport}><FaFileExcel /> Export To Excel</button>
                            </div>
                            <div className="ms-5 mt-3 search-button">
                                <button className="btn btn-danger" onClick={handleExportPDF}><AiOutlineFilePdf /> Export To PDF</button>
                            </div>
                        </div>
                                    ...
                                    {filteredData.map((item) => (
                                        <>
                                            <tr key={item.id}>
                                                ...
                                                <td>
                                                    <i to="/verify-kyc" className="Blue"><button type="button" className="btn btn-outline-primary btn-sm  me-3" > view </button></i>
                                                </td>
                                            </tr>
