...
const AdminAddPandetails = () => {
    const [iState, updateState] = useState(initialState);
    const [loading, setLoading] = useState(false);
    const { pan_number, name, pan_status, ac_type, dob } = updateState
            ...
            <header className="d-flex flex-wrap justify-content-center mb-4 border-bottom top-header">
                <a href="/" className="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-dark text-decoration-none">
                    <div className="logo p-3">
                        <img className="img-fluid" src={logo}  alt='proper'/>
                    </div>
                </a>
...
export default AdminAddPandetails;
