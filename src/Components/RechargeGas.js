...
// import PayBillModalGas from './PayBillModalGas'
import gasCylinder from "../images/gascCylinder.jpg";
                ...
                <div className='row mb-5'>
                            ...
                            <div className="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                <div className="col-md-10">
                                    <select className="form-select" >
                                        <option>Select  Your Gas Provider</option>
                    ...
                    <div className='col-5 main-bg ms-5'>
                        <div className='text-center'>
                            <h4 style={{ color: "#2e26c6" }}>Gas  Bill<span style={{ color: "#e21d24" }}> Payment Offers</span></h4>
                        </div>
                        <img className="img-fluid pe-2" src={gasCylinder} />
                    </div>
