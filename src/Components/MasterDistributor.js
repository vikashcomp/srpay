            ...
            <div className='container main-bg mt-5 mb-5'>
                ...
                <div className=' container '>
                    <div className='row  justify-content-around '>
                        <div className='col-lg-2  text-center  distributor-box btn btn-light' >
                            <img className="img-fluid" src={aps} />
                            <div>
                                <h6>Aeps </h6>
                                <h6>₹:120000</h6>
                                <h6>Incentice:12</h6>
                        ...
                        <div className='col-lg-2   text-center distributor-box gx-5'>
                            <img className="img-fluid " src={rupee} />
                            <div>
                        ...
                        <div className='col-lg-2  text-center distributor-box gx-5'>
                            <img className='img-fluid' src={recharge} />
                            <div>
                                <h6>Recharge</h6>
                                <h6> ₹:10000</h6>
                                <h6>Incentive:10</h6>
                        ...
                        <div className='col-lg-2 text-center distributor-box gx-5'>
                            <img className='img-fluid' src={cardMachine} />
                            <div>
                                <h6>MATM</h6>
                                <h6>₹:8000</h6>
                                <h6>Incentive:55</h6>
                        ...
                        <div className='row justify-content-around mt-4'>
                            ...
                            <div className='col-lg-2   text-center distributor-box gx-5'>
                                <img className='img-fluid' src={paymentGateway} />
                                <div>
