...
const MoveToDistributorHistory = () => {
    ...
    return (
        ...
        <UserNav userRole={kycData?.user_type_label} />
            ...
            <div className='container fundRequestHistory mt-4 mb-3 '>
                <h2 style={{ color: "#e21d24" }}>Move To Distributor <span style={{ color: "#2e26c6" }}> History</span></h2>
...
export default MoveToDistributorHistory;
